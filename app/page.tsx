        ...
        <div className='flex flex-col h-auto min-h-[100dvh] items-center w-dvw'>
          ...
          <div className='flex flex-col gap-5 max-h-[100%] justify-center h-full w-full px-4 pt-5 pb-40 lg:w-[900px]'>
            ...
            <div className='flex flex-rows flex-wrap items-center justify-between w-full fixed left-5 sm:left-10 md:left-15 lg:left-64 xl:left-84 bottom-10 max-w-[90%] lg:max-w-[60%]'>
              ...
              <div className={'flex flex-cols items-center justify-between border border-red-400 rounded-3xl text-white w-full p-2' + (openMenu ? ' bg-[rgb(80,80,80)] opacity-60 pointer-events-none lg:pointer-events-auto lg:bg-[rgb(80,80,80)] lg:opacity-100 ' : ' bg-[rgb(80,80,80)] ')}>
